...
public class Print {
  ...
  void prExp(OpExp e, int d) {
    ...
    case OpExp.AND: say("GE"); break;
    case OpExp.OR: say("GE"); break;
    case OpExp.UMINUS: say("GE"); break;
    default:
  ...
  //  prExp((OpExp) e.left, d+1); sayln(",");
  //  prExp((OpExp) e.right, d+1); say(")");
  }
  ...
  void prExp(IfExp e, int d) {
    ...
    //prExp((OpExp) e.test, d+1); sayln(",");
   // prExp((OpExp) e.thenclause, d+1);
    if (e.elseclause!=null) { /* else is optional */
      sayln(",");
     // prExp((OpExp) e.elseclause, d+1);
  ...
  void prExp(ForExp e, int d) {
   ...
   // prExp((OpExp) e.hi, d+1); sayln(",");
   // prExp((OpExp) e.body, d+1); say(")");
  }
  ...
  void prExp(ArrayExp e, int d) {
   ...
   // prExp((OpExp) e.size, d+1); sayln(",");
   // prExp((OpExp) e.init, d+1); say(")");
  }
